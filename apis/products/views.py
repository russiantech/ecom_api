...
from apis.file_uploads.models import ProductImage
...
mandatory_fields = ['images', 'title', 'price', 'contact', 'location', 'desc', 'category']
...
@api_bp.route('/products/<product_slug>', methods=['GET'])
...
@api_bp.route('/products/by_id/<product_id>', methods=['GET'])
...
@api_bp.route('/products/<product_slug>', methods=['PUT'])
@jwt_required()
...
@api_bp.route('/products/<product_slug>', methods=['DELETE'])
@jwt_required()
...
@api_bp.route('/products/by_id/<product_id>', methods=['DELETE'])
@jwt_required()
