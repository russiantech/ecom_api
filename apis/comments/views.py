...
from apis.comments.serializers import CommentListSerializer, CommentDetailsSerializer
from routes import api_bp
from apis.shared.serializers import get_success_response, get_error_response


@api_bp.route('/products/<product_slug>/comments', methods=['GET'])
...
@api_bp.route('/products/<product_slug>/comments', methods=['POST'])
@jwt_required()
